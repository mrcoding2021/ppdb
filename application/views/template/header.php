...
<head>
    ...
    <meta name="description" content="Menjadi koperasi Syariah yang amanah dan terdepan dalam membangun perekonomian umat" />
    ...
    <meta property="og:image" content="<?= base_url('asset/img/post/')  ?>simpanan.jpg">
