...
<head>
    <meta charset="utf-8">
    <title>Pengajuan Penerimaan KAS</title>
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="3">
                    <table>
                        <tr>
                            ...
                            <td>Alamat : <br>
                                <?= $sekolah['alamat'] ?>
                                <br> Kontak Kami : <?= $sekolah['hp'].' / '. $sekolah['tlp'] ?>
                            </td>
            ...
            <tr class="heading">
                <td colspan="4">
                    <center>
                        <h3>FORM PERSETUJUAN PEMASUKAN KAS</h3>
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <strong>
                        ...
                        echo $murid->nama . '<br> Telp : ' . $murid->hp . '<br>' . $murid->alamat;
                        ?><br>
                    </strong>
