...
<head>
  ...
  <title>SISTEM PEMBAYRAN SEKOLAH</title>
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center pb-3">
                   ...
                   <h3>SDIT Insan Mulia</h3>
                    
                  </div>
                  <div><?= $this->session->flashdata('alert') ?></div>
                  <form class="user" action="<?= base_url('auth/login') ?>" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email" name="username">
                    </div>
                    <div class="form-group">
