            ...
            <div class="row">
              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <form class="user" action="<?= base_url('adm/login') ?>" method="post">
                  ...
                  <div class="text-center">
                    <span class="small" href="#">SDIT INSAN MULIA</span>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    $('.lihat').click(function(e) {
      if ($('input[name="password"]').attr('type') == 'password') {
        ...
        $(this).attr('class', 'lihat fa fa-eye-slash')
      } else {
        $('input[name="password"]').attr('type', 'password')
        $(this).attr('class', 'lihat fa fa-eye')
      }
    })
  </script>
</body>
