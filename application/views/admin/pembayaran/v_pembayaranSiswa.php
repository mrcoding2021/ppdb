                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form action="<?= base_url('pembayaran/inputData') ?>" class="inputData" method="POST">
                                            <table class="table table-bordered" width="100%" cellspacing="0" id="table-pembayaranSiswa">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        function dataPembayaranSiswa() {
                            ...
                            var pembayaranSiswa = $('#table-pembayaranSiswa').DataTable({
                                'ajax': {
                                    "type": "POST",
                                    "url": '<?= base_url('sispem/pembayaranSiswa') ?>',
                                    "dataSrc": ""
                                },
                                "destroy": true,
                                'columns': [{
