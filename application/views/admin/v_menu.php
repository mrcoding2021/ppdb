                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="2" name="akses">
                                <option value="4" readonly>Pilih</option>
                                <?php foreach ($akses as $a) { ?>
                                    <option value="<?= $a->id_user ?>"><?= $a->menu ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <form action="<?= base_url('menu/editMenu') ?>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="2" name="akses">
                                    <option readonly>Pilih</option>
                                    <?php foreach ($akses as $hak) : ?>
                                        <option <?= ( $hak_akses == $hak->id_user)?'selected':''?> value="<?= $hak->id_user ?>"><?= $hak->menu ?></option>
                                    <?php endforeach ?>
