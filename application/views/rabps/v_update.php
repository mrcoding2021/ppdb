                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="hidden" class="form-control-sm form-control id_rab" value="<?= ($rinci->id_rab) ?? 0 ?>" name="id_rab">
                                                                        <input type="hidden" class="form-control-sm form-control bulan" value="<?= $bulan ?>" name="bulan">
                                                                        <input type="hidden" class="form-control-sm form-control ta" value="<?= ($rinci->ta) ?? '' ?>" name="ta">
                                                                    ...
                                                                    <td><input type="text" class="form-control-sm form-control qty" value="<?= ($rinci->qty) ?? '' ?>" name="qty"></td>
                                                                    <td><input type="text" class="form-control-sm form-control hrg_satuan" value="<?= ($rinci->hrg_satuan) ?? '' ?>" name="hrg_satuan"></td>
                                                                    <td><input type="text" class="form-control-sm form-control jumlah" value="<?= ($rinci->jumlah) ?? 0 ?>" name="jumlah"></td>
                                                                    <td>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('.save').click(function(e) {
                            ...
                            var id_rab = parents.find('.id_rab').val()
